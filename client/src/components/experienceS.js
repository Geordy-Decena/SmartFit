...
function ExperienceS() {
    ...
    return (
        <Fragment>
            <div className="S-expWhiteSpace">
                <div className="S-experience">
                    <div className="S-lightWave"></div>
                    <div className="S-smoothTrans"></div>
                    <div className="S-expContent">
                        <div className="S-simpleEduShare">
                        ...
                        <div className="S-simple3jprecision">
