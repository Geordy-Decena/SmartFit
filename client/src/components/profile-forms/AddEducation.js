    ...
    return (
        <Fragment>
            ...
            <form class="form" onSubmit={e => {
                ...
                <div class="form-group">
                    <p><input type="checkbox" name="current" checked={current} value={current} onChange={e => { setFormData({ ...formData, current: !current }); toggleDisabled(!toDateDisabled) }} /> {''}Current Education</p >
                </div>
                <div class="form-group">
                    <h4>To Date</h4>
